		...
		<nav className='py-4'>
			<div className='main-container flex items-center justify-between'>
				<div className='flex items-center'>
					<img className='mr-6 max-w-[20px] cursor-pointer lg:hidden' src='./assets/menu-m.svg' alt='menu button' />
					<a href='http://www.semoud.com/portfolio'>
						<img className='max-w-[125px]' src='./assets/logo.svg' alt='WeWork logo' />
					</a>
				</div>
				<div className='flex items-center'>
					<div className='absolute top-0 -left-full flex h-full w-full flex-col bg-white px-12 lg:relative lg:mx-0 lg:flex lg:h-auto lg:w-auto lg:flex-row lg:items-center lg:bg-transparent'>
						<div className='cursor-pointer py-8 lg:hidden'>
